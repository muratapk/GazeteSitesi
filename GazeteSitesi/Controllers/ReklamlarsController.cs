...
namespace GazeteSitesi.Controllers
{
    public class ReklamlarsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReklamId,ReklamKonu,ReklamResim,KonumId")] Reklamlar reklamlar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReklamId,ReklamKonu,ReklamResim,KonumId")] Reklamlar reklamlar)
        {
