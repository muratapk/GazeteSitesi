...
namespace GazeteSitesi.Controllers
{
    public class GazetesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GazeteId,GazeteAdi,GazeteLogo,GazeteSlogan,GazeteEmail,GazeteFacebook,GazeteInstagram,GazeteYoutube,GazeteTelefon,GazeteAdres")] Gazete gazete)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GazeteId,GazeteAdi,GazeteLogo,GazeteSlogan,GazeteEmail,GazeteFacebook,GazeteInstagram,GazeteYoutube,GazeteTelefon,GazeteAdres")] Gazete gazete)
        {
